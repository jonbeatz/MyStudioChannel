...
| ID | Date | Summary |
|----|------|---------|
| **RP-2026-06-08-v7-release** | 2026-06-08 | **v7.0.0 release on `MSC-Website-v7`:** Version **7.0.0** @ **`d65c3e6`**; Hostinger MCP launcher; docs sync; GitHub tag **`v7.0.0`**. Cut from frozen `MSC-Website-v6` @ `c9e260e`. Backup **`msc-website-v2-f`**. **Restore:** `git fetch --tags origin && git checkout v7.0.0` or `MSC-Website-v7 && git reset --hard d65c3e6`. **Restore v6 clean:** `git checkout MSC-Website-v6 && git reset --hard c9e260e`. |
