...
| ID | Date | Summary |
|----|------|---------|
| **RP-2026-06-11-v8-start** | 2026-06-11 | **`MSC-Website-v8` branch cut:** Active dev from frozen **`MSC-Website-v7`** @ **`b4ab8ae`** (hygiene complete, CI green, backup **`msc-website-v2-k`**). Version still **7.0.0** until release bump. **Restore v7:** `git fetch origin && git checkout MSC-Website-v7 && git reset --hard b4ab8ae`. **Restore v8:** `git fetch origin && git checkout MSC-Website-v8 && git pull`. |
