...
| ID | Date | Summary |
|----|------|---------|
| **RP-2026-06-13-v9-start** | 2026-06-13 | **`MSC-Website-v9` branch cut + v8.0.0:** Active dev from frozen **`MSC-Website-v8`** @ **`c0d834e`** (ngrok + litellm restored, backups standard complete, CI green). Version **8.0.0** in **`package.json`**. **Restore v8:** `git fetch origin && git checkout MSC-Website-v8 && git reset --hard c0d834e`. **Restore v9:** `git fetch --tags origin && git checkout MSC-Website-v9 && git pull`. |
