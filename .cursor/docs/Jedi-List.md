...
**Single source of truth:** root **`package.json`** **`"version"`** (currently **`8.0.0`** on **`MSC-Website-v8`**). **`lib/msc-app-version.ts`** imports it for the marketing footer (**`MyStudioChannel v8.0.0`**) and Payload admin sidebar (**`MyStudioChannel Admin v8.0.0`**).
