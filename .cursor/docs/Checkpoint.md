...
## Current Status
- **Date:** 2026-06-19 (MSC-Website-v10 branch cut + Mem0 VRAM preflight)
- **Branch:** MSC-Website-v10 @ `dd61788`
...
- **Git:** **`MSC-Website-v10`** active @ `dd61788`; **`MSC-Website-v9`** frozen @ `0007312`; **`MSC-Website-v8`** frozen @ `c0d834e`; **`main`** @ `b4ab8ae`
...
- **Backup:** quick **`msc-website-v3-i`** @ `G:\Cursor_Project_BackUpz\MyStudioChannel\`

## Recent milestones
| Date | Milestone | Commit |
|------|-----------|--------|
| 2026-06-19 | **MSC-Website-v10 branch cut + v10.0.0 release** | `dd61788` |
| 2026-06-19 | **Mem0 VRAM preflight (8192 ctx, ~4 GB) + session stack em-dash fix** | `0007312` |
...
## Session checklist
- [x] Branch `MSC-Website-v10` created from `MSC-Website-v9` @ `0007312`
