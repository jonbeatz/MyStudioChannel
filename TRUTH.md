...
- **Primary Branch:** `MSC-Website-v10` (active dev); **`MSC-Website-v9`** frozen @ `0007312`; **`MSC-Website-v8`** frozen @ `c0d834e`; **`MSC-Website-v7`** frozen @ `b4ab8ae`; **`main`** @ `b4ab8ae`; **`MSC-Website-v6`** frozen @ `c9e260e`
...
**Live:** [https://mystudiochannel.com](https://mystudiochannel.com) · **Dev branch:** `MSC-Website-v10` · **Repo version:** **v10.0.0** (deploy to update live footer/admin label)
