...
- **Primary Branch:** `MSC-Website-v7` (active dev @ `5596b56`); **`main`** synced @ `5596b56`; **`MSC-Website-v6`** frozen @ `c9e260e`
...
*Last Updated: 2026-06-11 (v7.0.0 · `MSC-Website-v7` + `main` @ `5596b56` · hygiene complete, audit queue closed)*  
